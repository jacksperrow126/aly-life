export const moneyIncomeType = [
    { name: 'Lương', id: 'luong', icon: 'assets/icon/salary.svg' },
    { name: 'Thưởng', id: 'thuong', icon: 'assets/icon/reward.svg' },
    { name: 'Tiền lãi', id: 'lai', icon: 'assets/icon/interest.svg' },
    { name: 'Quà', id: 'qua', icon: 'assets/icon/gift.svg' },
    { name: 'Khác', id: 'income', icon: 'assets/icon/income-other.svg' }
];
